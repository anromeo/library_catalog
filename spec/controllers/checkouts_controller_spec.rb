  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved checkout as @checkout" do
        ...
        post :create, {:checkout => { "book_id" => "invalid value" }}, valid_session
        assigns(:checkout).should be_a_new(Checkout)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested checkout" do
        ...
        Checkout.any_instance.should_receive(:update_attributes).with({ "book_id" => "1" })
        put :update, {:id => checkout.to_param, :checkout => { "book_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the checkout as @checkout" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Checkout.any_instance.stub(:save).and_return(false)
        put :update, {:id => checkout.to_param, :checkout => { "book_id" => "invalid value" }}, valid_session
        assigns(:checkout).should eq(checkout)
      end
